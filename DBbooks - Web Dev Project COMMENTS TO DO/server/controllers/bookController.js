...
exports.signup = async(req, res) => {
  ...
  res.render('sign-up', { title: 'Sign Up', infoErrorsObj, infoSubmitObj  } );
}
...
exports.login = async(req, res) => {
  const infoErrorsObj = req.flash('infoErrors');
  const infoSubmitObj = req.flash('infoSubmit');
  res.render('log-in', { title: 'Log In', infoErrorsObj, infoSubmitObj  } );
}
...
//Submitting a book to mongo logic
